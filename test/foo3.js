...
var json_data_1 = require("./foo3.json");

contract('ContentReward TEST foo3', function() {
  ...
  it("0. basic part", async() => {
    ...
    await cr.sendTransaction({from: web3.eth.accounts[3], to: cr.address, value: 15*10**18});
    // pubslish content
