...
var json_data_1 = require("./foo10.json");

contract('ContentReward TEST foo10', function() {
  ...
  it("0. basic part", async() => {
    ...
    await cr.sendTransaction({from: web3.eth.accounts[0], to: cr.address, value: 15*10**18});
    // pubslish content
  ...
  it("10. publish favor under comment", async() => {
    const cr = await ContentReward.deployed();
